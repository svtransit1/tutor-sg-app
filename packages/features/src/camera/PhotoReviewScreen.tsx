    ...
    () =>
      PanResponder.create({
        ...
        onPanResponderMove: (event: GestureResponderEvent) => {
          ...
          // locationX/locationY are relative to the crop box top-left
  ...
  return (
    <View style={styles.cropContainer} pointerEvents="box-none">
      ...
      <View style={styles.cropActions}>
        <Pressable style={styles.cropCancelButton} onPress={onCancel}>
          <Text style={styles.cropCancelText}>{t('camera.photoReview.cancelCrop')}</Text>
        </Pressable>
        <Pressable
          style={styles.cropConfirmButton}
          onPress={() => onConfirm({ x: offset.x, y: offset.y, scale })}
        >
          <Text style={styles.cropConfirmText}>{t('camera.photoReview.confirmCrop')}</Text>
        </Pressable>
      </View>
    </View>
  );
        ...
        <View style={styles.actionRow}>
          ...
          {onCropConfirm && !showCrop && (
            <Pressable
              ...
              accessibilityRole="button"
              accessibilityLabel={t('camera.photoReview.cropButton')}
            >
              <Text style={styles.cropButtonText}>
                {t('camera.photoReview.crop')}
              </Text>
            </Pressable>
          )}

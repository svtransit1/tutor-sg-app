...
const s = StyleSheet.create({
  ...
  hintText: { color: '#FFF', fontSize: 16, textAlign: 'center', opacity: 0.7, backgroundColor: 'rgba(0,0,0,0.3)', paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, overflow: 'hidden' },
  ...
  body: { fontSize: 16, textAlign: 'center', lineHeight: 24, marginBottom: 24 },

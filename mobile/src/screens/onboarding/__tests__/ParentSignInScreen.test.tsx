 ...
 * Note: fireEvent-based interaction tests require resolving a
 * pre-existing React version mismatch (react 19.2.6 vs
 * react-native-renderer 19.1.0); render-only tests work.
 */
  ...
  useTranslation: () => ({
    t: (key: string, _params?: Record<string, unknown>) => {
      const keys: Record<string, string> = {
        ...
        'onboarding.progress.step': 'Step 5 of 7',
        'onboarding.progress.accessibility': 'Step 5 of 7',
      };
      return keys[key] ?? key;
    },
  }),
...
// Mock OnboardingProgressIndicator — null component to avoid react-native import in mock factory

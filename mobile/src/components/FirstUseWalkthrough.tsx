    ...
    <View style={styles.overlay}>
      ...
      >
        ...
        >
          ...
          <Text style={[styles.body, { color: isDark ? '#B0B0B0' : '#6B7280' }]}>
            {content.body}
          </Text>
          ...
          <View style={styles.actions}>
            ...
            >
              <Text style={[styles.skipText, { color: isDark ? '#9CA3AF' : '#9CA3AF' }]}>
                {t('tutorial.skip')}
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              ...
              accessibilityRole="button"
              accessibilityLabel={isLast ? t('tutorial.gotIt') : t('tutorial.next')}
              hitSlop={{ top: 12, bottom: 12, left: 12, right: 12 }}
              activeOpacity={0.8}
            >

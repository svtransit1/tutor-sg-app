...
describe('DrawingCanvas', () => {
  ...
  it('renders canvas area', () => {
    ...
    render(<DrawingCanvas strokes={[]} onStrokesChange={onStrokesChange} testID="drawing-canvas" />)
  ...
  it('renders placeholder text when empty', () => {
    const onStrokesChange = jest.fn()
    render(<DrawingCanvas strokes={[]} onStrokesChange={onStrokesChange} placeholder="Draw here" />)
  ...
  it('uses default accessibilityLabel when not provided', () => {
    const onStrokesChange = jest.fn()
    render(<DrawingCanvas strokes={[]} onStrokesChange={onStrokesChange} />)

    // With the i18n mock, the key string is returned as-is
    expect(screen.getByLabelText('manualInputFallback.accessibility.drawCanvas')).toBeTruthy()
  })
  ...
  it('shows clear button when strokes exist', () => {
    ...
    render(<DrawingCanvas strokes={mockStrokes} onStrokesChange={onStrokesChange} />)
  ...
  it('renders in dark mode', () => {
    ...
    jest.spyOn(require('react-native'), 'useColorScheme').mockImplementation(mockUseColorScheme)
